...
class Persona {
   ...
   detalle(){
      ...
      var infoPersona = {}
         ...
         infoPersona.apellido = this.apellido;
         infoPersona.edad = this.edad;
         infoPersona.domicilio = this.domicilio;
...
function crearInstanciaPersona(nombre, apellido, edad, domicilio) {
   ...
   var nuenaPersona = new Persona(nombre, apellido, edad, domicilio);
